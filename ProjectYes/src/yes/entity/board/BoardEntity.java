...
public class BoardEntity {
	...
	public BoardEntity(int brdno, int bgno, String brdtitle, int userno, String brdmemo, Date brddate,
			String noticeflag, Date lastdate, int brdlike, String deleteflag, int brdhit) {
		super();
		this.brdno = brdno;
		this.bgno = bgno;
	...
	public String toString() {
		return "BoardEntity [brdno=" + brdno + ", bgno=" + bgno + ", brdtitle=" + brdtitle + ", userno=" + userno
