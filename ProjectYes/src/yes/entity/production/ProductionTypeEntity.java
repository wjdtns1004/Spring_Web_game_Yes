...
public class ProductionTypeEntity {
	...
	public ProductionTypeEntity() {}


	public ProductionTypeEntity(int protno, String protname, String protype, int protlevel, int reqtime, int reqmoney,
	...
	public String toString() {
		return "ProductionTypeEntity [protno=" + protno + ", protname=" + protname + ", protype=" + protype
				+ ", protlevel=" + protlevel + ", reqtime=" + reqtime + ", reqmoney=" + reqmoney + ", reqproduce="
				+ reqproduce + ", reqrealestate=" + reqrealestate + ", reqworker=" + reqworker + ", getexp=" + getexp
				+ ", prodamt=" + prodamt + ", remark=" + remark + ", percent=" + percent + "]";
	}
