$(document).ready(function(){
	...
	$("body").on("mousemove",function(e){
		...
		$(".obj12").css({"right":120+posX , "top":-175+posY });
		$(".obj13").css({"left":0+posX , "bottom":20+posY });

		$(".obj21").css({"right":-610-posX , "bottom":-420-posY });
		$(".obj22").css({"right":0+posX , "bottom":-100+posY });

		$(".obj31").css({"right":100-posX , "bottom":70-posY });
		$(".obj32").css({"left":0-posX , "bottom":-160+posY });
...
//		$(".obj53").css({"left":100+posX , "bottom":200-posY });
	});
